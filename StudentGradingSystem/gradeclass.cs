...
{
    /// <summary>
    /// Represents a class for handling grading-related operations.
    /// </summary>
    public class gradeclass
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="gradeclass"/> class.
        /// </summary>
        ...
        /// <param name="sDatapath">The data path for the grading system.</param>
        ...
        /// <summary>
        /// Retrieves the dataset for loading data.
        /// </summary>
        /// <returns>The dataset containing grading information.</returns>
        ...
        /// <summary>
        /// Retrieves the dataset for loading data with a specified sort field.
        /// </summary>
        ...
        {
            using (System.Data.OleDb.OleDbConnection conn = GetConnection())
            {
                DataSet ds = new DataSet();

                try
                {
                    string sql = "SELECT STUDENTID,data1 AS Firstname, data2 AS Lastname, " +
                                 "data3 AS 20, data4 AS EG, data5 AS [1st-10%], " +
                                 "data6 AS 50pt, data7 AS EG1, data8 AS [2nd-10%], " +
                                 "data9 AS 50pts, data10 AS EG2, data11 AS [20%], " +
                                 "data12 AS 100pt, data13 AS EG3, data14 AS [30%], " +
                                 "data15 AS 100, data16 AS EG4, data17 AS [2nd-30%], " +
                                 "data18 AS PrelimGrade, data19 AS Remarks FROM Table1 ORDER BY ID";

                    using (System.Data.OleDb.OleDbDataAdapter da = new System.Data.OleDb.OleDbDataAdapter(sql, conn))
                    {
                        da.Fill(ds, "grade1");
                    }
                ...
                {
                    // No need to close and dispose as the using statement takes care of it.
                }
            }
        }
        ...
        public void RefreshDGV()
        {
            ...
            {
                string sql = "SELECT STUDENTID, data1 AS Firstname, data2 AS Lastname," +
                             " data3 AS 20, data4 AS EG, data5 AS [1st-10%], data6 AS 50pt," +
                             " data7 AS EG1, data8 AS [2nd-10%], data9 AS 50pts, data10 AS EG2," +
                             " data11 AS [20%], data12 AS 100pt, data13 AS EG3, data14 AS [30%]," +
                             " data15 AS 100, data16 AS EG4, data17 AS [2nd-30%], data18 AS PrelimGrade," +
        ...
        /// <summary>
        /// Saves an item to the database with a specified sort field.
        /// </summary>
        /// <param name="sortfield">The field used for sorting.</param>
        /// <returns>The dataset containing the saved item.</returns>
        ...
        /// <summary>
        /// Navigates through the dataset.
        /// </summary>
        /// <returns>The dataset used for navigation.</returns>
        ...
        /// <summary>
        /// Navigates through the dataset with a specified sort field.
        /// </summary>
        /// <param name="sortfield">The field used for sorting.</param>
        /// <returns>The dataset used for navigation.</returns>
        ...
        /// </summary>
        /// <returns>The dataset containing the updated data.</returns>
        ...
        /// <summary>
        /// Updates data in the database with a specified sort field.
        /// </summary>
        /// <param name="sortfield">The field used for sorting.</param>
        /// <returns>The dataset containing the updated data.</returns>
